...
--
-- Host: localhost:3306
-- Generation Time: Aug 04, 2026 at 12:07 PM
...
CREATE TABLE `agendas` (
  ...
  `color` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '#1572E8',
...
CREATE TABLE `asset_maintenance_logs` (
  ...
  `type` enum('routine','repair','inspection') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `performed_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cost` decimal(12,2) NOT NULL DEFAULT '0.00',
  `result_status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `crews` (
  ...
  `nationality` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Indonesia',
  `seafarer_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `seafarer_book_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(31, '2026_08_03_000000_add_location_and_photo_to_vessel_certificates_table', 24);
...
CREATE TABLE `projects` (
  ...
  `type` enum('time_charter','freight_charter','shipping_agency') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Jenis project / kontrak',
  `start_date` date DEFAULT NULL,
  `end_date` date DEFAULT NULL,
  `contract_value` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT 'Nilai kontrak / nilai jual project',
  `status` enum('draft','active','finished','cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft' COMMENT 'Status project operasional',
  `created_by` bigint UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `project_document_types` (
  `id` bigint UNSIGNED NOT NULL,
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` enum('time_charter','freight_charter','shipping_agency') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_by` bigint UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `project_voyages` (
  ...
  `period_id` bigint UNSIGNED NOT NULL,
  `project_id` bigint UNSIGNED NOT NULL,
  `spal_number` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(12, 9, 13, 44, '0', 3, 2, 6, 1000, 'Kl', 6, '2026-06-13 07:35:44', '2026-08-04 10:57:43');
...
('Nir2bt93GqtxIEZy8On5aa4vZut9l96R90JrKgAj', 7, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36', '', 1785845229);
...
CREATE TABLE `vessel_certificates` (
  ...
  `certificate_file` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `vessel_certificates` (`id`, `company_id`, `vessel_id`, `name`, `lokasi`, `issue_date`, `expiry_date`, `certificate_file`, `foto`, `created_by`, `created_at`, `updated_at`) VALUES
(29, 11, 9, 'ANTI FOULING SYSTEM', NULL, '2025-11-14', '2028-02-01', 'vessel-certificates/MBsPjAWK4gPB0mKmtGcZCsO7DqEWHOEz2cB7Alhv.pdf', NULL, 7, '2026-03-26 03:34:14', '2026-03-26 03:34:14'),
(30, 11, 9, 'SURAT LAUT', NULL, '2025-12-20', '2026-12-20', 'vessel-certificates/FuL2juOe8bkH6S8BRKE13ZzonKg414QV1uF9HuxY.pdf', NULL, 7, '2026-03-26 03:35:28', '2026-03-26 03:35:28'),
(31, 11, 9, 'SERTIFIKAT SANITASI', NULL, '2026-03-15', '2026-09-15', 'vessel-certificates/axJz6vxaWxQe9rFJ6ddqh3KqyacN9cgKBqCkSSNl.pdf', NULL, 7, '2026-03-26 03:36:19', '2026-05-19 04:25:33'),
(32, 11, 9, 'KES.PERLENGKAPAN', NULL, '2025-08-15', '2026-07-31', 'vessel-certificates/fGQaCQwPVUdcbsqzGb2ozpySvgxgoFcSVaUZJHuC.pdf', NULL, 7, '2026-03-26 03:37:36', '2026-03-26 03:37:36'),
(33, 11, 9, 'KES.KONSTRUKSI', NULL, '2025-08-15', '2026-07-31', 'vessel-certificates/nBsHByDKzULVGdU3yWyRAr8mGx07L2fEEW6Iiit6.pdf', NULL, 7, '2026-03-26 03:38:34', '2026-03-26 03:38:34'),
(34, 11, 9, 'ILR, FE, HRU', NULL, '2026-07-06', '2026-07-06', 'vessel-certificates/hJhrgE4mb97tzVck7BAhr7ZD8DPIDQbkFEEA7YFS.pdf', NULL, 7, '2026-03-26 03:39:37', '2026-03-26 03:39:37'),
(36, 11, 9, 'SNPP', NULL, '2024-12-11', '2026-12-11', 'vessel-certificates/iX7IHEhO3y4DXfmDwESpNRCPHhan464O6tzQvIwP.pdf', NULL, 7, '2026-03-26 03:41:16', '2026-03-26 03:41:16'),
(37, 11, 9, 'SURAT UKUR', NULL, '2011-11-06', '2030-11-06', 'vessel-certificates/u8I9mVDv5WKgC4TD1f28X6gi4wPNfV8ic34c8wGe.pdf', NULL, 7, '2026-03-26 03:42:36', '2026-03-26 03:42:36'),
(38, 11, 8, 'RPK TRAMPER', NULL, '2026-04-30', '2026-08-25', 'vessel-certificates/MqO21XWw8ftWkzoXg9ISuvaVfW6kycpliuisiAqz.pdf', NULL, 7, '2026-03-26 03:54:06', '2026-07-24 07:55:04'),
(39, 11, 8, 'SNPP', NULL, '2025-11-24', '2028-08-24', 'vessel-certificates/v0tAugDKyRj3j6I2clmqqUsdVYxqC0xBqlSJdeg9.pdf', NULL, 7, '2026-03-26 03:55:20', '2026-03-26 03:55:20'),
(40, 11, 8, 'KES.RADIO', NULL, '2026-06-14', '2026-07-16', 'vessel-certificates/F7hkVf0ixfIDBw7WGxElYOzPazSMpv18oNwI4eqw.pdf', NULL, 7, '2026-03-26 03:56:32', '2026-07-24 07:53:33'),
(41, 11, 8, 'KES.PERLENGKAPAN', NULL, '2026-06-14', '2026-07-16', 'vessel-certificates/YAG8HxvUCIs8VvdZM6FuGt9KTa0GhVaOQDxYMy37.pdf', NULL, 7, '2026-03-26 03:57:25', '2026-07-24 07:54:06'),
(42, 11, 8, 'KES.KONSTRUKSI', NULL, '2026-06-14', '2026-07-16', 'vessel-certificates/JFk1JrV4dtflYb27HxInIHIBJDF8A46Q3RDgjWK1.pdf', NULL, 7, '2026-03-26 03:58:31', '2026-07-24 07:54:44'),
(43, 11, 8, 'ILR, FE, HRU', NULL, '2025-08-15', '2026-08-15', 'vessel-certificates/1UuNfA5QlIaDvCC7ySD5DGO5xDaFhuaEEYoR5AkM.pdf', NULL, 7, '2026-03-26 04:00:01', '2026-03-26 04:00:01'),
(44, 11, 8, 'SANITASI KAPAL / SSCEC', NULL, '2026-03-15', '2026-09-15', 'vessel-certificates/QSxKqtE5UH0WwIYwHAQcO8UTefEwjbUTPCkFBEeO.pdf', NULL, 7, '2026-03-26 04:01:11', '2026-05-19 04:22:22'),
(45, 11, 8, 'CLC OIL POLLUTION & REMOVAL OF WRECKS', NULL, '2025-09-16', '2026-08-08', 'vessel-certificates/iz300rG9SdEA5cLF8wFuc7kpLPa9nXRyQ9WqL2ux.pdf', NULL, 7, '2026-03-26 04:02:18', '2026-03-26 04:02:18'),
(46, 11, 8, 'SURAT LAUT', NULL, '2025-08-29', '2026-08-29', 'vessel-certificates/5HQG06bosd8ipfysfyOLEIOeSje0b32rgovhosgw.pdf', NULL, 7, '2026-03-26 04:04:54', '2026-03-26 04:04:54'),
(47, 11, 8, 'GROSS AKTA', NULL, '2019-05-03', '2050-05-03', 'vessel-certificates/VCQxbI0RvhnVjFsQHn7G9hV6Q9XCNa0F2qt2Xm66.pdf', NULL, 7, '2026-03-26 04:06:17', '2026-03-26 04:06:17'),
(48, 11, 8, 'ANTI FOULING SYSTEM', NULL, '2024-12-08', '2026-07-14', 'vessel-certificates/x48X3uKcVoFXnw2usIzsi8mkG49B7RNOL7PEgGBT.pdf', NULL, 7, '2026-03-26 04:07:54', '2026-03-26 04:07:54'),
(49, 11, 8, 'SPESIFIKASI KAPAL', NULL, '2019-11-06', '2050-11-06', 'vessel-certificates/mVYmd3zoJzVMUbGCskjCk6Sf0gcxEelovPa9L9Sf.pdf', NULL, 7, '2026-03-26 04:08:48', '2026-03-26 04:08:48'),
(50, 11, 8, 'KLAS BKI MESIN', NULL, '2024-03-15', '2028-11-23', 'vessel-certificates/XyBCUADtqJPAtovkQsn3n6HfuLf43WumkXmgEF5B.pdf', NULL, 7, '2026-03-26 04:09:49', '2026-03-26 04:09:49'),
(51, 11, 8, 'KLAS BKI LOADLINE', NULL, '2024-03-15', '2028-11-23', 'vessel-certificates/e6RwZZmY5UVZlpYDuqcc5mPFpqGq9p6ysVrjzIqj.pdf', NULL, 7, '2026-03-26 04:10:54', '2026-03-26 04:10:54'),
(52, 11, 8, 'KLAS BKI LAMBUNG', NULL, '2024-03-15', '2028-11-23', 'vessel-certificates/SdDYQdtPHtaGD212ceYfTDtE6ELAfbJkYmjvpEAb.pdf', NULL, 7, '2026-03-26 04:12:19', '2026-03-26 04:12:19'),
(53, 11, 8, 'SAFE MANNING', NULL, '2026-05-25', '2026-08-24', 'vessel-certificates/Am6lB834ErZqGIp6SfrSWi1z9UGQ5oMJeVAOk1WU.pdf', NULL, 7, '2026-03-26 04:13:14', '2026-07-24 07:57:10'),
(54, 11, 8, 'SURAT UKUR', NULL, '1998-04-05', '2050-04-05', 'vessel-certificates/gjEEaf0G3CsPcZPtwVoqFXMnK0kvV343J805Wa07.pdf', NULL, 7, '2026-03-26 04:14:09', '2026-03-26 04:14:09'),
(59, 11, 9, 'BKI - LOAD LINE', NULL, '2025-09-18', '2027-03-10', 'vessel-certificates/NrZfCLdaKwtvHMdqW2YQxX14pehVJDOygYeoDrGk.pdf', NULL, 7, '2026-07-24 08:09:05', '2026-07-24 08:09:05'),
(60, 11, 9, 'BKI - LAMBUNG', NULL, '2025-09-18', '2027-03-10', 'vessel-certificates/LuXMv1pLTUM5Ox1QD0k2BqTWXnMhpC0JCuF14yAp.pdf', NULL, 7, '2026-07-24 08:09:51', '2026-07-24 08:09:51'),
(61, 11, 9, 'BKI - MESIN', NULL, '2025-09-18', '2027-03-10', 'vessel-certificates/SU85E1szNQWdUqyFAXJKHv3u4kRh9zfcDhfoe07w.pdf', NULL, 7, '2026-07-24 08:10:28', '2026-07-24 08:10:28'),
(62, 11, 9, 'RPK TRAMPER', NULL, '2026-05-26', '2026-08-25', 'vessel-certificates/jTnDwt0fvRfxogADjvXkmOFu9krhJbbXuiWSXqCY.pdf', NULL, 7, '2026-07-24 08:11:52', '2026-07-24 08:11:52'),
(63, 11, 9, 'SPEK KAPAL', NULL, '2026-05-25', '2027-05-13', 'vessel-certificates/hTnxamGK1HwLQPAyboQkQ85x1UwzxIo4nYeX5CNG.pdf', NULL, 7, '2026-07-24 08:12:53', '2026-07-24 08:12:53');
