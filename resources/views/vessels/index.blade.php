    ...
    <div class="container">
        <div class="page-inner">
            ...
            <div class="d-flex justify-content-between align-items-center py-3">
                <div>
                    <h3 class="fw-bold mb-0">Registered vessels</h3>
                    <p class="text-muted mb-0">
                        Vessels registered for this company
                    </p>
                </div>
                <div>
            ...
            <style>
                ...
                #vesselTable .table tbody td .badge,
                #vesselTable .table tbody td i,
                #vesselTable .table tbody td .btn {
                    margin: 0 !important;
                            ...
                            <table class="table table-hover mb-0 align-middle">
                                ...
                                <tbody>
                                    @forelse ($vessels as $vessel)
                                        <tr>
                                            <td>{{ $loop->iteration + ($vessels->currentPage() - 1) * $vessels->perPage() }}
                                            </td>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-2">
                                    <div class="btn-group w-100" role="group">
                                        ...
                                        <form action="{{ route('vessels.destroy', $vessel) }}" method="POST"
                                            class="d-inline flex-fill" onsubmit="return confirm('Delete this vessel?')">
                                            @csrf
                                            @method('DELETE')
                    ...
                    @empty
                        <div class="card border-0 shadow-sm">
                            <div class="card-body text-center text-muted py-4">
                                ...
                                <small>
                                    Please add a vessel to get started
                                </small>
