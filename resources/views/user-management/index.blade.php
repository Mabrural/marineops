                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a class="dropdown-item text-primary" href="{{ route('user-management.edit', $user->id) }}">
                                                    ...
                                                    <li>
                                                        ...
                                                        @else
                                                            <form action="{{ route('user-management.grant-admin', $user->id) }}" method="POST" class="grant-form">
                                                                @csrf
                                                    ...
                                                    <li>
                                                        @if ($user->is_active)
                                                            <form action="{{ route('user-management.deactivate', $user->id) }}" method="POST" class="deactivate-form">
                                                                @csrf
                                                                <button type="submit" class="dropdown-item text-warning">
                                                        ...
                                                        @else
                                                            <form action="{{ route('user-management.activate', $user->id) }}" method="POST" class="activate-form">
                                                                @csrf
                                                                <button type="submit" class="dropdown-item text-success">
                                                    ...
                                                    <li>
                                                        <form action="{{ route('user-management.destroy', $user->id) }}" method="POST" onsubmit="return confirmDelete(event)">
                                                            @csrf
                                                            @method('DELETE')
