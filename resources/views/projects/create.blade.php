                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="type"
                                            ...
                                            <option value="time_charter" {{ old('type') == 'time_charter' ? 'selected' : '' }}>
                                                Time Charter
                                            </option>
                                            <option value="freight_charter" {{ old('type') == 'freight_charter' ? 'selected' : '' }}>
                                                Freight Charter
                                            </option>
                                            <option value="shipping_agency" {{ old('type') == 'shipping_agency' ? 'selected' : '' }}>
                                                Shipping Agency
                                            </option>
                                        </select>
                                        @error('type')
