    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Create New Cargo</h4>
                    ...
                    <div class="card">
                        ...
                        <form method="POST" action="{{ route('cargos.store') }}">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                                ...
                                                placeholder="e.g. POME" required autofocus>
                                            @error('name')
                            ...
                            <div class="card-action">
                                ...
                                <a href="{{ route('cargos.index') }}" class="btn btn-danger">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
