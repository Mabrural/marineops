                    ...
                    <table class="table table-hover mb-0 align-middle">
                        ...
                        <tbody>
                            @forelse ($documentTypes as $documentType)
                                <tr>
                                    <td>{{ $loop->iteration + ($documentTypes->currentPage() - 1) * $documentTypes->perPage() }}</td>
                ...
                <div class="card mb-2">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            ...
                            <div class="text-end">
                                <a href="{{ route('ports.edit', $documentType) }}"
                                    class="btn btn-sm btn-warning mb-1">
                                    <i class="fas fa-edit"></i>
                                </a>

                                <form action="{{ route('ports.destroy', $documentType) }}"
                                    method="POST"
                                    onsubmit="return confirm('Delete this company?')">
                                    @csrf
                                    @method('DELETE')
