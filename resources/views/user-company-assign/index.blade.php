    ...
    <div class="container">
        <div class="page-inner">
            ...
            <div class="d-flex justify-content-between align-items-center py-3">
                <div>
                    <h3 class="fw-bold mb-0">User Company Assignment</h3>
                    <p class="text-muted mb-0">Assign system users to a company and manage their access status</p>
                </div>
            </div>
                            ...
                            <tbody>
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="fw-bold">{{ $user->company->name ?? '-' }}</div>
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    @else
                                                        <li>
                                                            <form
                                                                action="{{ route('user-company-assign.destroy', $user->id) }}"
