    ...
    <div class="container">
        <div class="page-inner">
            ...
            <div class="d-flex justify-content-between align-items-center py-3">
                <div>
                    <h3 class="fw-bold mb-0">Registered ports</h3>
                    <p class="text-muted mb-0">
                        Ports registered for this company
                    </p>
                </div>
                <div>
                    <a href="{{ route('ports.create') }}" class="btn btn-primary btn-sm">
            ...
            <style>
                ...
                #portTable .table tbody tr {
                    height: 20px !important;
                }

                /* Hilangkan spacing tambahan */
                #portTable .table tbody td .badge,
                #portTable .table tbody td i,
                #portTable .table tbody td .btn {
                    margin: 0 !important;
                            ...
                            <table class="table table-hover mb-0 align-middle">
                                ...
                                <tbody>
                                    @forelse ($ports as $port)
                                        <tr>
                                            <td>{{ $loop->iteration + ($ports->currentPage() - 1) * $ports->perPage() }}
                                            </td>
                                            ...
                                            <td>
                                                <a href="{{ route('ports.edit', $port) }}" class="btn btn-sm btn-warning">
                                                    <i class="fas fa-edit"></i>
                                                </a>

                                                <form action="{{ route('ports.destroy', $port) }}" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-2">
                                    <div class="btn-group w-100" role="group">
                                        ...
                                        <a href="{{ route('ports.edit', $port) }}" class="btn btn-warning">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>

                                        <form action="{{ route('ports.destroy', $port) }}" method="POST"
                                            class="d-inline flex-fill" onsubmit="return confirm('Delete this port?')">
                                            @csrf
                                            @method('DELETE')
                    ...
                    @empty
                        <div class="card border-0 shadow-sm">
                            <div class="card-body text-center text-muted py-4">
                                ...
                                <small>
                                    Please add a port to get started
                                </small>
