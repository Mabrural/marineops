                                            ...
                                            <select class="form-control @error('vessel_id') is-invalid @enderror"
                                                ...
                                                @foreach ($vessels as $vessel)
                                                    <option value="{{ $vessel->id }}"
                                                        {{ old('vessel_id', $crew->vessel_id) == $vessel->id ? 'selected' : '' }}>
                                                        {{ $vessel->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                                id="name" name="name" value="{{ old('name', $crew->name) }}"
                                                required>
                                            @error('name')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('gender') is-invalid @enderror"
                                                ...
                                                <option value="Male"
                                                    {{ old('gender', $crew->gender) === 'Male' ? 'selected' : '' }}>
                                                    Male
                                                </option>
                                                <option value="Female"
                                                    {{ old('gender', $crew->gender) === 'Female' ? 'selected' : '' }}>
                                                    Female
                                                </option>
                                            </select>
                                            @error('gender')
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date"
                                                ...
                                                value="{{ old('date_of_birth', optional($crew->date_of_birth)->format('Y-m-d')) }}">
                                            @error('date_of_birth')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="seafarer_code" name="seafarer_code"
                                                value="{{ old('seafarer_code', $crew->seafarer_code) }}">
                                            @error('seafarer_code')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="seafarer_book_number" name="seafarer_book_number"
                                                value="{{ old('seafarer_book_number', $crew->seafarer_book_number) }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date"
                                                ...
                                                id="seafarer_book_expired_at" name="seafarer_book_expired_at"
                                                value="{{ old('seafarer_book_expired_at', optional($crew->seafarer_book_expired_at)->format('Y-m-d')) }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('position', $crew->position) }}">
                                            @error('position')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('certificate', $crew->certificate) }}">
                                            @error('certificate')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
